...
if __name__ == "__main__":
    ...
    #--------------------------------------------#
    name_classes    = ["background","disasters"]
    ...
    visual_dir      = os.path.join(miou_out_path, 'visual')
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            #测试集可视化
            image_np = np.array(Image.open(save_path))
            image_np[image_np != 0] = 255  # Set all non-zero values to 255
            visual_save_path = os.path.join(visual_dir, image_id + ".png")
            Image.fromarray(image_np).save(visual_save_path)
